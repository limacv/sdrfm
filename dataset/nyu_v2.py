...
from dataset.preprocesses import remove_leading_slash
...
class Nyu_v2(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if has_valid_depth:
            ...
            depth_gt = depth_gt / 1000.0 # depth preprocess
...
def get_nyu_loader(config, batch_size=1, **kwargs):
    dataset = Nyu_v2(config)
